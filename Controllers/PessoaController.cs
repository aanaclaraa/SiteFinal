...
namespace SiteFinal.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomePessoa,IdadePessoa,Sexo")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomePessoa,IdadePessoa,Sexo")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
