...
namespace SiteFinal.Controllers
{
    public class MarcaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeMarca,PrecoMarca")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeMarca,PrecoMarca")] Marca marca)
        {
            if (id != marca.Id)
            {
                return NotFound();
