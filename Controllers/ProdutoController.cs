...
namespace SiteFinal.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Peso,Preco,DataValidade,Observacao")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Peso,Preco,DataValidade,Observacao")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
